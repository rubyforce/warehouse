...
ActiveRecord::Schema.define(version: 20151203170438) do
  ...
  create_table "vehicle_loading_items", force: :cascade do |t|
    t.integer  "item_id"
    t.string   "qty"
    t.string   "s_qty"
    t.decimal  "rate"
  ...
  create_table "vehicle_unloading_items", force: :cascade do |t|
    t.integer  "item_id"
    t.string   "qty"
    t.string   "s_qty"
    t.string   "return"
  ...
  create_table "vehicle_unloadings", force: :cascade do |t|
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.date     "date"
    t.string   "voucher_no"
